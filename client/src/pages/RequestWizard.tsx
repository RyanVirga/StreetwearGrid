                      ...
                      <div key={color.id} className="relative">
                        ...
                        {color.id.startsWith('custom-') && (
                          <button
                            ...
                            className="absolute top-0 right-0 translate-x-1/2 -translate-y-1/2 z-10 bg-destructive text-destructive-foreground rounded-full p-1 shadow-md hover-elevate"
